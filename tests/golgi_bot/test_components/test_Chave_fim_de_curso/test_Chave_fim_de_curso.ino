...
void setup() {     
  ...
  // Batente master
  endstop_R_master_X = new Chave_fim_de_curso(chave_master_R_X,false);
  ...
  endstop_L_slave_X = new Chave_fim_de_curso(chave_slave_L_X,true);
  endstop_L_slave_X->init();

  // Batente Z
  endstop_R_Z = new Chave_fim_de_curso(chave_R_Z,false);
  endstop_R_Z->init();


  endstop_L_Z = new Chave_fim_de_curso(chave_L_Z,false);
  endstop_L_Z->init(); 
  }
